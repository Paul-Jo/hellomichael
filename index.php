                ...
                <div class="col-xs-12">
                  <div class="heading">
                    ...
                    <h6 class="heading__subtitle subtitle">
                      Front-End Developer | Vancouver, Sydney <br/> Making the web more beautiful, one pixel at a time
                    </h6>
                  </div>
                </div>
            ...
            <div class="col-xs-12 col-md-11 col-md-centered col-lg-10 col-lg-push-1">
              ...
              <div class="section__row row row-thin">
                <div class="col-xs-12 col-sm-8">
                  <?php include('includes/web-directions/project.php');?>
                </div>

                <div class="col-xs-12 col-sm-4">
                  <?php include('includes/keno/project.php');?>
                </div>
              </div>

              <div class="section__row row row-thin">
                <div class="col-xs-12 col-sm-4">
                  <?php include('includes/business-events-sydney/project.php');?>
                </div>

                <div class="col-xs-12 col-sm-8">
                  <?php include('includes/smashing-magazine/project.php');?>
                </div>
              </div>

              <div class="section__row row row-thin">
                <div class="col-xs-12 col-sm-8">
                  <?php include('includes/foodsters/project.php');?>
                </div>

                <div class="col-xs-12 col-sm-4">
                  <?php include('includes/big-head-mode/project.php');?>
                </div>

                <div class="col-xs-12 col-sm-4">
                  <?php include('includes/this-is-neat/project.php');?>
                </div>

                <div class="col-xs-12 col-sm-4">
                  <?php include('includes/the-sockeye/project.php');?>
                </div>
              </div>
            </div>
          </div>
